...
<body>
    ...
    <br><br><br>
	<main>
		<form action="updateNotice.do?no=${board.no }" method="post" name="NoticeInfo"
			onsubmit="return faqCheck()">
			<div id="main-css">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="title" placeholder="제목"
						id="inputTitle" value="${board.title }">
				</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="content" placeholder="내용"
						...
						style="margin-top: 0px; margin-bottom: 0px; height: 200px;">${board.content }</textarea>
				</div>
				<br>
<!-- 				<div class="form-group">
