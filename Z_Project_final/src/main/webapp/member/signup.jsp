...
<script>
	...
	function signup_check() {
      ...
      if (document.signUpInfo.id.value.trim() == "") {
         alert("아이디를 입력하세요.");
         document.signUpInfo.id.value = "";
         document.signUpInfo.id.focus();
            return false;
      }
	
      if (document.signUpInfo.password.value.trim() == "") {
         alert("비밀번호를 입력하세요.");
         document.signUpInfo.password.value = "";
         document.signUpInfo.password.focus();
            return false;
      }
      if (document.signUpInfo.name.value.trim() == "") {
         alert("이름을 입력하세요.");
         document.signUpInfo.name.value = "";
         document.signUpInfo.name.focus();
            return false;
      }
      if (document.signUpInfo.email.value.trim() == "") {
         alert("이메일을 입력하세요.");
         document.signUpInfo.email.value = "";
         document.signUpInfo.email.focus();
            return false;
      }  
      if (document.signUpInfo.email.value.trim() == "") {
          alert("이메일을 입력하세요.");
      ...
      if (document.signUpInfo.certification_key.value.trim() != code) {
    	  alert("이메일 인증을 완료해주세요.");
             return false;
      } 

	   if (document.signUpInfo.phone.value.trim() == "") {
         alert("휴대폰 번호를 입력하세요.");
         document.signUpInfo.phone.value = "";
         document.signUpInfo.phone.focus();
            return false;
      }
      if (document.signUpInfo.birth.value.trim() == "") {
         alert("생년월일을 입력하세요.");
         document.signUpInfo.birth.value = "";
         document.signUpInfo.birth.focus();
            return false;
      }
      ...
      if ($("input:radio[name='agree2']").is(":checked") == false) {
    ...
    $(document).ready(function() {
       $("#userID").blur(function() {
          ...
          var userID_pattern = /^[a-zA-Z0-9]{4,16}$/;
         
          if (!userID_pattern.test(userID)) {
             $("#id_text").text("아이디는 숫자, 알파벳 4~16자");
    ...
    //이메일 인증 --------------------------------------------------
	function emailSend(){
	var emailText = document.getElementById('uesrEmail').value;
    ...
    if (document.signUpInfo.email.value.trim() == "") {
		...
		$.ajax({
			type : "GET",
			url : "email_check.do?emailText" + emailText,
			data : {"emailText" : $('#uesrEmail').val()},
			success : function(data){
			code = data;

			},
			error : function(e){
			alert('인증 오류입니다. 잠시 후 다시 시도해주세요')
		}
	});
};
   
    //회원가입 인증번호 확인
	function mail_check_input(){
   ...
   $(document).ready(function() {
      $("#userPassword2").blur(function() {
         ...
         if (userPassword1 != userPassword2) {
            ...
            document.signUpInfo.password_check.value = "";
         } else {
            $("#password_text2").text("");
         }
      });
   ...
   $(document).ready(function() {
      $("#uesrName").blur(function() {
         ...
         var userName_pattern = /^[가-힝a-zA-Z]{2,10}$/;
         
         if (!userName_pattern.test(uesrName)) {
            $("#name_text").text("이름은 한글, 알파벳 2~10자");
   ...
   <%-- 휴대폰 번호 예외처리 --%>
   $(document).ready(function() {
      $("#uesrPhone").blur(function() {
         var uesrPhone = $("#uesrPhone").val();
         var uesrPhone_pattern = /^[0-9]{10,11}$/;
         
         if (!uesrPhone_pattern.test(uesrPhone)) {
            $("#phone_text").text("ex) 01012345678");
   ...
   <%-- 생년월일 예외처리 --%>
   $(document).ready(function() {
      $("#uesrBirth").blur(function() {
         var uesrBirth = $("#uesrBirth").val();
         var uesrBirth_pattern = /^[0-9]{6}$/;
         
         if (!uesrBirth_pattern.test(uesrBirth)) {
            $("#birth_text").text("생년월일은 ex) 940902");
            $("#birth_text").css("color","red");
            document.signUpInfo.birth.value = "";
            return false;
         } else {
            $("#birth_text").text("");
...
<div class="wrapper fadeInDown zero-raduis">
  	  <div id="formContent">
  	    <div class="fadeIn first">
  	      <h4 class="my-5">회원가입 </h4>
  	    </div>
  	    <!-- Login Form -->
  	    <form action="signup.do" method="post" name="signUpInfo">
  	      <input type="text" name="id" placeholder="아이디를 입력해주세요" id="userID">
  	      <div id="id_text"></div>
  	      <input type="password" name="password" placeholder="비밀번호를 입력해주세요" id="userPassword1">
  	      <div id="password_text1" class="check_color"></div>
		  <input type="password" name="password_check" placeholder="비밀번호를 확인해주세요" id="userPassword2">
		  <div id="password_text2" class="check_color"></div>    
		  <input type="text" name="name" placeholder="이름을 입력해주세요" id="uesrName">
		  <div id="name_text" class="check_color"></div>
		  <input type="email" name="email" placeholder="이메일을 입력해주세요" id="uesrEmail">
		  <div id="email_text" class="check_color"></div>
		  <input type="button" name="emailCheck" class="btn_confirm" id="emailCheck" value="인증번호 전송" onclick="emailSend();" >
		  <input type="text" name="certification_key" class="mail_check_input" placeholder="인증번호를 입력해주세요">
		  <input type="button" name="certification" id="certificationBtn" onclick="mail_check_input();" value="인증하기">
		  <input type="text" name="phone" placeholder="휴대폰 번호" id="uesrPhone">
		  <div id="phone_text" class="check_color"></div>
		  <input type="text" name="birth" placeholder="생년월일" id="uesrBirth">
		  <div id="birth_text" class="check_color"></div>
		  <br>
		  
		  <!-- 이용약관  -->
               <div class="checkbox_wrap">
               <div><input type="radio" name="agree" value="true"> 이용약관 동의 (필수)
               	<button type="button" data-toggle="modal" data-target="#myModal" class="myButton"> 보기
             	</button>
			 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <textarea class="modal-body" cols="60" rows="10" disabled>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
               ...
               <div class="checkbox_wrap">
               <div><input type="radio" name="agree2" value="true"> 개인정보 수집 및 이용 동의(필수)
               	<button type="button" data-toggle="modal" data-target="#myModal2" class="myButton"> 보기
             	</button>
...
개인정보 최고 관리책임자 성명 : 남윤아
전화번호 : 010-2589-0452
이메일 : dbsdk0070@gamil.com
...
2) 시행일자 : 2018년 05월 01일 
                 ...
                 <br>
            <div class="btn_wrap">
           		 <input type="button" value="회원가입" onclick="signup_check(this.form)">
            </div>
   	</form>
    </div>
  </div>
